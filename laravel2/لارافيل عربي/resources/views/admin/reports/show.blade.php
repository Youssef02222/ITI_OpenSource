                            ...
                            <div class="card-body">
                                ...
                                <div class="media m-b-30 my-2">
                                    <div class="media-body">
                                        <div class="form-group col-md-5 mx-auto ms-5">
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-12 p-3  text-center">
                        ...
                        <div class="form-group col-md-6 mx-auto ms-5">
                            <form class="mb-3" action="{{Route('close.report.store')}}" method="post">
                                ...
                                <input type="hidden" name="id" value="{{$report->id}}">
                                <button type="submit"  class="btn btn-warning my-2" {{$report->status === 'مغلق'?'disabled':''}}>{{$report->status === "مغلق" ? 'تم اغلاق البلاغ' : 'اغلاق البلاغ'}}</button>
                            </form>
                        </div>
                        ...
                        <form class="mb-3" action="{{Route('reports.destroy',$report->id)}}" method="post">
                            ...
                            <button type="submit" class="btn btn-danger" >حذف البلاغ</button>

                        </form>

                        @role('رئيس قسم')
                        <div class="form-group col-md-6 mx-auto ms-5">
                        <form class="mb-3" action="{{Route('admin.change_status')}}" method="post">
                            @csrf
                            ...
                            <input type="hidden" name="id" value="{{$report->id}}">
                            <button type="submit" class="btn btn-info my-2" >تغيير حالة البلاغ</button>
