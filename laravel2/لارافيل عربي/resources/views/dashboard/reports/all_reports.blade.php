                ...
                <div class="card m-b-30 dash-widget">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h5 class="card-title mb-0">جميع البلاغات</h5>
                            </div>
                                ...
                                @foreach($manager as $report)
                                    <tr>
                                        ...
                                        @if($report->status === 'مكتمل')
                                            <td><span class="badge badge-success-inverse">{{$report->status}}
                                        </span></td>
                                        ...
                                        @elseif($report->status === 'مغلق')
                                            <td><span class="badge badge-warning-inverse">{{$report->status}}
                                        </span></td>
                                        @endif
